...
from .models import (
    ...
    OneToOneFieldModel, RequiredModel, DecoratedModel, TestRootPage,
    TestSlugPage1, TestSlugPage2, PatchTestPage, PatchTestSnippet,
    FieldPanelPage, ImageChooserPanelPage, FieldRowPanelPage,
...
class FallbackModel2TranslationOptions(TranslationOptions):
    fields = ('title', 'text', 'url', 'email',)
    fallback_values = {'text': ugettext_lazy(
...
translator.register(ImageChooserPanelSnippet,
                    ImageChooserPanelTranslationOptions)
...
translator.register(StreamFieldPanelSnippet,
                    StreamFieldPanelTranslationOptions)
