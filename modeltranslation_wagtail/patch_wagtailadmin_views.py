...
def new_copy(request, page_id):
    ...
    # Create the form
    form = NewCopyForm(request.POST or None, page=page,
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            new_page = page.copy(
                ...
                keep_live=(can_publish and form.cleaned_data.get(
                    'publish_copies')),
                user=request.user,
            )
            ...
            if form.cleaned_data.get('copy_subpages'):
                messages.success(
                    ...
                    _("Page '{0}' and {1} subpages copied.").format(
                        page.title, new_page.get_descendants().count())
                )
            else:
                messages.success(request, _(
                    "Page '{0}' copied.").format(page.title))
